...
use Drupal\contentservice\Plugin\rest\resource\csShowProductUpdatesn;
...
/**
 * Provides unit tests for the csShowProductUpdatesnTest Plugin.
 *
 * @coversDefaultClass \Drupal\contentservice\Plugin\rest\resource\csShowProductUpdatesnTest
 * @group contentservice
 */
class csShowProductUpdatesnTest extends UnitTestCase
{
  /**
   * configuration.
   *
  ...
  */
  protected function setUp(): void {
    parent::setUp();
    $this->pluginId = 'showproduct update';
    $this->pluginDefinition['title'] = 'showallupdates';
  ...
  public function testConstructor() {
    ...
    $createbroadcast_object = new csShowProductUpdatesn(
	  $this->configuration,
	  $this->pluginId,
    ...
    $this->assertInstanceOf(csShowProductUpdatesn::class, $createbroadcast_object);
  }
  ...
  public function testCreate() {
	...
	$createnewsc_object = csShowProductUpdatesn::create($container, $this->configuration,$this->pluginId, $this->pluginDefinition);
  ...
  public function testGet() {
    ...
    $query_mock->expects($this->at(3))->method('condition')
      ->with('field_product_type', 'product_updates');
    ...
    $contact_mock = $this->getMockBuilder(csShowProductUpdatesn::class)
      ->disableOriginalConstructor()
