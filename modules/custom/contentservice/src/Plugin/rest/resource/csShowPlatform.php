   ...
   public function get($id) {
		...
		if(is_numeric($id)) {
			...
			$result[] = [
				...
				"body"=>  $nodeEntity->body->value,
				"banner"=>  $nodeEntity->field_banner->value,
				"banner_description"=>  $nodeEntity->field_banner_description->value,
				"banner_thumbnail"=>  $nodeEntity->field_banner_thumbnail->value,
