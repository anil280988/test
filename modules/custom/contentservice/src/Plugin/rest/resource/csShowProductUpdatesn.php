 ...
 *
 * @RestResource(
 *   id = "concierto_cs_show_productupdates_new",
 *   label = @Translation("concierto cs show product updates new"),
 *  serialization_class = "",
 *   uri_paths = {
 *      "canonical" = "/api/csShowProductUpdatesn/{type}",
 *   }
 * )
 */
class csShowProductUpdatesn extends ResourceBase
{
  ...
  public function get($type)
  {
    ...
    $query->condition('field_product_type', $type, '=');
