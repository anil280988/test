...
use Drupal\contentservice\Plugin\rest\resource\csDeleteNews;
...
class csDeleteNewsTest extends UnitTestCase
{
  ...
  public function testDelete()
  {
    ...
    $product_mock = $this->getMockBuilder(Drupal\contentservice\Plugin\rest\resource\csDeleteNews::class)
      ->disableOriginalConstructor()
  ...
  public function testDeleteWhenInvalidLogin()
  {
    ...
    $contact_mock = $this->getMockBuilder(Drupal\contentservice\Plugin\rest\resource\csDeleteNews::class)
      ->disableOriginalConstructor()
      ->setMethodsExcept(['delete'])
      ->getMock();
