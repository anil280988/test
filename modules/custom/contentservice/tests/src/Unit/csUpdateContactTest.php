...
use Drupal\contentservice\Plugin\rest\resource\csUpdateContact;
 ...
 */
class csUpdateContactTest extends UnitTestCase
{
  /**
  ...
  public function testPut() {
    ...
    $product_mock = $this->getMockBuilder(Drupal\contentservice\Plugin\rest\resource\csUpdateContact::class)
      ->disableOriginalConstructor()
  ...
  /**
   * Test case when html tag in name.
   *
   * @return void
   */
  public function testPutWhenNameFieldHasTags() {
  ...
  /**
   * Test case when html tag in region.
   *
   * @return void
   */
  public function testPutWhenRegionFieldHasTags() {
   ...
   * @return void
   */
  public function testPutWhenInvalidFileExt() {
   ...
   * @return void
   */
  public function testPutWhenDomainNotMatch() {
