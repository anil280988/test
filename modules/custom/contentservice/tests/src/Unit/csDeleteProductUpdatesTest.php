...
use Drupal\contentservice\Plugin\rest\resource\csDeleteProductUpdates;
...
class csDeleteProductUpdatesTest extends UnitTestCase
{
   ...
   * @return void
   */
  public function testDeleteWhenTypeIs1()
  {
    ...
    $product_mock = $this->getMockBuilder(Drupal\contentservice\Plugin\rest\resource\csDeleteProductUpdates::class)
      ->disableOriginalConstructor()
   ...
   * @return void
   */
  public function testDeleteWhenTypeIs2()
  {
   ...
   * @return void
   */
  public function testDeleteWhenTypeIs3()
  {
  ...
  public function testDeleteWhenInvalidLogin()
  {
    ...
    $contact_mock = $this->getMockBuilder(Drupal\contentservice\Plugin\rest\resource\csDeleteProductUpdates::class)
      ->disableOriginalConstructor()
      ->setMethodsExcept(['delete'])
      ->getMock();
