 ...
 *
 * @coversDefaultClass \Drupal\contentservice\Plugin\rest\resource\csShowallBroadcast
 * @group contentservice
 */
class csShowallBroadcastTest extends UnitTestCase {
  ...
  public function testConstructor() {
    ...
    $showprodupdates_object = new csShowallBroadcast(
      $this->configuration,
      $this->pluginId,
    ...
    $this->assertInstanceOf(csShowallBroadcast::class, $showprodupdates_object);
  }
  ...
  public function testCreate() {
    ...
    $createnewsc_object = csShowallBroadcast::create($container, $this->configuration, $this->pluginId, $this->pluginDefinition);
  ...
  public function testGet() {
    ...
    $field_user_group = $this->getMockBuilder('\Drupal\Core\Field\FieldItemListInterface')
      ->disableOriginalConstructor()
      ->getMock();

    $field_user_group->expects($this->any())
      ->method('getValue')
      ->willReturn([0 => ['value' => 'test group']]);
    ...
    $contact_mock = $this->getMockBuilder(csShowallBroadcast::class)
      ->disableOriginalConstructor()
