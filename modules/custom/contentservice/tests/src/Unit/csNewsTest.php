...
class csNewsTest extends UnitTestCase
{
  ...
  public function testGet() {
    ...
    $field_news_categories_mock = $this->getMockBuilder('\Drupal\Core\Field\FieldItemListInterface')
      ->disableOriginalConstructor()
      ->getMock();
    $field_news_categories_mock->expects($this->any())
      ->method('getValue')
      ->willReturn([0 => ['value' => 'test_term_id']]);

    $field_news_description_mock = $this->getMockBuilder('\Drupal\Core\Field\FieldItemListInterface')
      ->disableOriginalConstructor()
      ->getMock();
    $field_news_description_mock->expects($this->any())
      ->method('getValue')
      ->willReturn([0 => ['value' => 'test_term_id']]);

    $field_trending_mock = $this->getMockBuilder('\Drupal\Core\Field\FieldItemListInterface')
      ->disableOriginalConstructor()
      ->getMock();
    $field_trending_mock->expects($this->any())
      ->method('getValue')
      ->willReturn([0 => ['value' => 'test_term_id']]);

    $field_banner_url_mock = $this->getMockBuilder('\Drupal\Core\Field\FieldItemListInterface')
      ->disableOriginalConstructor()
      ->getMock();
    $field_banner_url_mock->expects($this->any())
      ->method('getValue')
      ->willReturn([0 => ['value' => 'test_term_id']]);

    $field_tags_mock = $this->getMockBuilder('\Drupal\Core\Field\FieldItemListInterface')
      ->disableOriginalConstructor()
      ->getMock();
    $field_tags_mock->expects($this->any())
      ->method('getValue')
      ->willReturn([0 => ['value' => 'test_term_id']]);
