...
use Drupal\contentservice\Plugin\rest\resource\csDeleteContact;
...
class csDeleteContactTest extends UnitTestCase
{
  ...
  public function testDelete()
  {
    ...
    $product_mock = $this->getMockBuilder(Drupal\contentservice\Plugin\rest\resource\csDeleteContact::class)
      ->disableOriginalConstructor()
  ...
  public function testDeleteWhenInvalidLogin()
  {
    ...
    $contact_mock = $this->getMockBuilder(Drupal\contentservice\Plugin\rest\resource\csDeleteContact::class)
      ->disableOriginalConstructor()
      ->setMethodsExcept(['delete'])
      ->getMock();
