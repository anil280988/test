...
class GenericServiceTest extends UnitTestCase {
   ...
   * @return void
   */
  public function testuserDuplicateLoginValidationWhenTokenMatch()
  {
  ...
  /**
   * Test case: When client id match
   * @return void
   */
  public function testuserClientPermissioCheckWhenClientIDMatch()
  {
    ...
    $service_mock = $this->getMockBuilder(GenericService::class)
      ->disableOriginalConstructor()
      ->setMethodsExcept(['userClientPermissioCheck'])
      ->getMock();

    $result = $service_mock->userClientPermissioCheck('client_id');
    $this->assertEquals(1, $result);
   ...
   * @return void
   */
  public function testuserClientPermissioCheckWhenClientIDNotMatch()
  {
    ...
    $fieldDescMock->expects($this->any())
      ->method('getValue')
      ->willReturn([0 => ['value' => 'client_id_1']]);
